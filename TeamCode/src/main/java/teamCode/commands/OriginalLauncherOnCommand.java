...
public class OriginalLauncherOnCommand extends CommandBase
{
    ...
    public OriginalLauncherOnCommand(LauncherSubsystem launcherSubsystem, AxeSubsystem axeSubsystem, HuskyLensSubsystem huskyLensSubsystem, HoodServoSubsystem hoodSubsystem)
    {
        m_position = m_down;
