...
//import teamCode.subsystems.PurplePotatoSorterSubsystem;
//
...
//    private final PurplePotatoSorterSubsystem m_intakePivotSubsystem;
//    private int m_position;
//    private static final int  m_sample = 1;
//    private static final int  m_specimen = 0;
//
//    public IntakePivotCommand(PurplePotatoSorterSubsystem pivotSubsystem)
//    {
...
//        {
//            this.m_intakePivotSubsystem.SpinSorter(m_specimenPos);
//            m_position = m_sample;
//        }
//        else if (m_position == m_sample)
//        {
//            this.m_intakePivotSubsystem.SpinSorter(m_samplePos);
//            m_position = m_specimen;
//        }
//
//    }
