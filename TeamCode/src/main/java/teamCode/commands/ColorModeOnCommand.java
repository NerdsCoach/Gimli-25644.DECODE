...
public class ColorModeOnCommand extends CommandBase
{
    ...
    private final LightBSubsystem m_lightBSubsystem;
    ...
    public ColorModeOnCommand(ColorSensorSubsystem colorSubsystem, LightBSubsystem lightBSubsystem)
    {
        this.m_colorSubsystem = colorSubsystem;
        this.m_lightBSubsystem = lightBSubsystem;

        addRequirements(m_colorSubsystem, m_lightBSubsystem);
    }
    ...
    public void execute()
    {
            ...
            {
                m_lightBSubsystem.lastKnown(m_lastKnownColor); // Default to off
            }
