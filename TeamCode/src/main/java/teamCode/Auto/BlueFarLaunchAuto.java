...
@Autonomous(name="Blue Far Launch Auto", group="Pinpoint")
//@Disabled

public class BlueFarLaunchAuto extends LinearOpMode
{
    /* Drivetrain */
...
////    private HuskyLensSubsystem m_huskyLensSubsystem;
    ...
    static final Pose2DUnNormalized Line1A = new Pose2DUnNormalized(DistanceUnit.MM, 0, -750, UnnormalizedAngleUnit.DEGREES, 0);
    static final Pose2DUnNormalized Line1B = new Pose2DUnNormalized(DistanceUnit.MM, 360, -750, UnnormalizedAngleUnit.DEGREES, 0);
    static final Pose2DUnNormalized EndLine1 = new Pose2DUnNormalized(DistanceUnit.MM, 1360, -750, UnnormalizedAngleUnit.DEGREES, 10);
    static final Pose2DUnNormalized Line2 = new Pose2DUnNormalized(DistanceUnit.MM, 410, -1300, UnnormalizedAngleUnit.DEGREES, 0);
    static final Pose2DUnNormalized EndLine2 = new Pose2DUnNormalized(DistanceUnit.MM, 1000, -1300, UnnormalizedAngleUnit.DEGREES, 0);
    static final Pose2DUnNormalized Line3 = new Pose2DUnNormalized(DistanceUnit.MM, 430, -1900, UnnormalizedAngleUnit.DEGREES, 0);
    static final Pose2DUnNormalized EndLine3 = new Pose2DUnNormalized(DistanceUnit.MM, 1020, -1900, UnnormalizedAngleUnit.DEGREES, 0);
...
//        sortPos = 1;
        ...
        this.m_intakeSubsystem = new IntakeServoSubsystem(this.m_intakeServo);
        ...
        while (opModeIsActive())
        {
            ...
            switch (m_stateMachine)
            {
                case WAITING_FOR_START:
                    ...
                    this.m_turnTableMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);                m_stateMachine = StateMachine.PREPARE_FOR_BATTLE;
                    break;
                ...
                case PREPARE_FOR_BATTLE:
                    ...
                    {
                        if(m_turnTableSubsystem.atTargetRight(0)) //-575
                        {
                ...
                case LAUNCH_BALL_1:
                    if (this.m_turnTableSubsystem.atTargetRight(0)) //-575
                    {
                        //Transfer On
...
//                        this.m_transferSubsystem.spinTransfer(0.0);
                        ...
                        m_stateMachine = StateMachine.LINE_1A;
                ...
                case LINE_1A:
                    if (nav.driveTo(new Pose2DUnNormalized(DistanceUnit.MM, m_odo.getPosX(DistanceUnit.MM), m_odo.getPosY(DistanceUnit.MM), UnnormalizedAngleUnit.DEGREES, m_odo.getHeading(UnnormalizedAngleUnit.DEGREES)),
                            Line1A, 0.6, 0))
                    {
                        this.m_intakeSubsystem.spinIntake(-1.0);
                        telemetry.addLine("Done");
                        m_stateMachine = StateMachine.LINE_1B;
                    }
                    break;
                ...
                case LINE_1B:
                    ...
                    {
                        telemetry.addLine("Done");
                        m_stateMachine = StateMachine.END_LINE_1;
                    }
                    break;
...
//                case LAUNCH_BALL_2:
//                    if (this.m_turnTableSubsystem.atTargetRight(-550))
//                    {
//                        //Transfer On
