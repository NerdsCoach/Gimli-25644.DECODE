...
@Autonomous(name="Blue Near Auto", group="Pinpoint")
//@Disabled
...
public class BlueNearAuto extends LinearOpMode
{
    ...
    static final Pose2DUnNormalized Park = new Pose2DUnNormalized(DistanceUnit.MM, -500, -300, UnnormalizedAngleUnit.DEGREES, 0);
...
//                    this.m_launcherSubsystem.setMotorVelocity(2700);
                ...
                case PREPARE_FOR_BATTLE:
                    ...
                    this.m_launcherSubsystem.setMotorVelocity(1850);
