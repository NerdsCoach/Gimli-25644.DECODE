...
@TeleOp(name = "Combined-RED-DECODE")
public class CombinedRobotContainerRed extends CommandOpMode
{
    ...
    //TODO Device Name MUST MATCH name on the Drivers Station!!!!!
        ...
        this.m_light = hardwareMap.get(Servo.class, "lightB");
        ...
        this.m_driveFieldOrientedCommand = new DriveFieldOrientedCommand
                (this.m_driveSubsystem,this.m_gamepadSubsystem,() -> this.m_driver2.getLeftX(),
                        () -> this.m_driver2.getLeftY(), () -> this.m_driver2.getRightX(), () -> this.m_driver2.getRightY());
        ...
        this.m_gyroResetButton = (new GamepadButton(this.m_driver2, GamepadKeys.Button.BACK))
